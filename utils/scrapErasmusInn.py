...
def erasmusInnAccommodations(filters=None):
    if filters is None:
        filters = {}
    ...
    route = '../data/accommodations_eri_' + city.replace('-', '_') + '.json'
    ...
    for accommodation in accommodations:
        ...
        price = int(price.replace('€', '').replace('$', '').replace('£', '').replace('TRY', '').replace('zł', ''))
