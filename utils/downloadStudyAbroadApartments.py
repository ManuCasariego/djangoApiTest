...
def studyAbroadAccommodations():
    ...
    save_to_file(dir, accommodations_madrid, 'accommodations_saa_madrid')
    save_to_file(dir, accommodations_new_york, 'accommodations_saa_new_york')
    save_to_file(dir, accommodations_barcelona, 'accommodations_saa_barcelona')
    save_to_file(dir, accommodations_florence, 'accommodations_saa_florence')
    save_to_file(dir, accommodations_granada, 'accommodations_saa_granada')
    save_to_file(dir, accommodations_london, 'accommodations_saa_london')
    save_to_file(dir, accommodations_milan, 'accommodations_saa_milan')
    save_to_file(dir, accommodations_prague, 'accommodations_saa_prague')
    save_to_file(dir, accommodations_paris, 'accommodations_saa_paris')
    save_to_file(dir, accommodations_rome, 'accommodations_saa_rome')
    save_to_file(dir, accommodations_san_sebastian, 'accommodations_saa_san_sebastian')
    save_to_file(dir, accommodations_valencia, 'accommodations_saa_valencia')
